...
方式1：通过 ghp.ci 代理脚本
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) 0c000d5e2b5b24c989a532aea95bbeb1
```
方式2：通过 GitHub 脚本
```bash
bash <(curl -Lk https://ghp.ci/https://github.com/kingparks/cursor-vip/releases/download/latest/install.sh) 0c000d5e2b5b24c989a532aea95bbeb1
```
方式3：手动下载二进制文件
